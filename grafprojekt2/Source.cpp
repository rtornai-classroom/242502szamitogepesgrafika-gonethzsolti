...
char		window_title[] = "Goneth Zsolt 2. bedando";
...
glm::vec3 controlPointsColor = glm::vec3(0.2f, 0.3f, 0.3f);
glm::vec3 controlPoligonColor = glm::vec3(0.9f, 0.8f, 0.6f);
glm::vec3 bezierCurveColor = glm::vec3(0.7f, 0.3f, 0.1f);
